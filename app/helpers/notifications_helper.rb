  ...
  def notification_form(notification)
    ...
    case notification.action
      ...
      when "post_comment" then
        ...
        tag.a(@action_user.full_name, href: user_path(@action_user), style: "font-weight: bold;") + "さんが" + tag.a('あなたのThanks!', href: post_path(notification.post_id), style: "font-weight: bold;") + "にコメントしました"
    end
  end
